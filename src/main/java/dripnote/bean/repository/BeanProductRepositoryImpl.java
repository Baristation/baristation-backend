...
import static dripnote.bean.domain.QBean.bean;
import static dripnote.bean.domain.QBeanProduct.beanProduct;
import static dripnote.bean.domain.QFlavorNote.flavorNote;
import static dripnote.bean.domain.QProduct.product;
import static dripnote.bean.domain.QProductFlavorNote.productFlavorNote;
import static dripnote.bean.domain.QRoaster.roaster;
