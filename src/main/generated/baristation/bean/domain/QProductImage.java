...
public class QProductImage extends EntityPathBase<ProductImage> {
    ...
    private static final long serialVersionUID = 1167890856L;
    ...
    public final EnumPath<baristation.bean.enums.ImageType> imageType = createEnum("imageType", baristation.bean.enums.ImageType.class);
